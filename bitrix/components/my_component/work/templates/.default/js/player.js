    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="34" height="34" data-play="playable" class="not-started playable">',
                ...
                '<circle class="precache-bar" cx="50" cy="50" r="47.45" stroke="#fff" stroke-opacity="0.25" stroke-linecap="round" fill="none" stroke-width="5" transform="rotate(-90 50 50)"/>',
                ...
                '</g>',
                '<circle class="controls" cx="50" cy="50" r="45" stroke="none" fill="#fff" opacity="0.0" pointer-events="all"/>',
